# Travis-ci helpers from myronmarston/vcr
require 'rubygems' if RUBY_VERSION =~ /^1\.8/
require 'rspec/core'
require 'rspec/expectations'
require 'tempfile'
stderr_file = Tempfile.new('cio.stderr')
  ...
  config.after(:suite) do
    ...
    vcr_warnings.reject! do |line|
      line.include?("#{current_dir}/spec/spec_helper.rb") ||
          line.include?("#{current_dir}/spec/support/monkey_patches.rb") ||
          line.include?("#{current_dir}/spec/lib/cio/version_spec.rb")
    end
